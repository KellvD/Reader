...
class CDReaderConfig: NSObject,NSCoding {
    ...
    var fontSize:Float!
    static let shared = CDReaderConfig()
...
@inline(__always) func separateChapter(_ chapters:inout [CDChapterModel],content:String) {
    chapters.removeAll()
...
//}
//
//@inline(__always) func parserContent(content:String,config:CDReaderConfig,bounds:CGRect) -> CTFrame{
...
//}
//
//@inline(__always) func parserAttribute(config:CDReaderConfig) -> [NSAttributedString.Key:Any]{
